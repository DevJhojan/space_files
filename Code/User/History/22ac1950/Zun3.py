...
class TodoProm:
    ...
    async def add_task(self, category):
        state = False
        title = input("Title: ")
        ...
        if category == "IU":
            ...
            try:
                ...
                await self.alarm(start_time, start_menssage)
            except ValueError:
            ...
            try:
                ...
                await self.alarm(end_time, end_menssage)
    ...
    async def alarm(self, date, mensaje="Alarm!"):
        ...
        if  restar_time.total_seconds() > 0:
            ...
            await asyncio.sleep(restar_time.total_seconds()) and self.todo_promp
            print(mensaje)
        
    async def todo_promp(self):
        ...
        while True:
            ...
            if inp == "create":
                ...
                asyncio.create_task(self.add_task(category))
