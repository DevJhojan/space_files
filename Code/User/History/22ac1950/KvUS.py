    ...
    def add_task(self, category):
        ...
        if category == "IU":
            ...
            try:
                ...
                self.alarm(start_time, "Start:" + title)
                self.alarm(end_time, "End: "+title)
                
            except ValueError:
                print("El formato no conside: " + start_time_str + ", or:"+end_time_str)
        if category == "INU":
