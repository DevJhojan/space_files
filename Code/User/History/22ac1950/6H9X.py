...
class TodoProm:
    ...
    async def add_task(self, category):
        ...
        if category == "IU":
            ...
            try:
                ...
                asyncio.create_task(self.alarm(end_time, end_menssage))
                await asyncio.gather(asyncio.sleep(0))
    ...
    async def alarm(self, date, mensaje="Alarm!"):
        ...
        if  restar_time.total_seconds() > 0:
            ...
            await asyncio.sleep(restar_time.total_seconds())# esta linea no ejecuta
            print(mensaje)
    ...
    async def todo_promp(self):
        ...
        while True:
            ...
            if inp == "create":
                ...
                await asyncio.gather(self.add_task(category))
                self.manager.save_to_file()
            if inp == "ok -1":
                id = input("Id of task: ")
